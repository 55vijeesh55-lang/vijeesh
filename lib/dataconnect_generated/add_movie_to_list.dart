...
class AddMovieToListVariablesBuilder {
  ...
  AddMovieToListVariablesBuilder(this._dataConnect, {required  this.listId,required  this.movieId,required  this.note,required  this.position,});
  ...
  MutationRef<AddMovieToListData, AddMovieToListVariables> ref() {
    AddMovieToListVariables vars= AddMovieToListVariables(listId: listId,movieId: movieId,note: note,position: position,);
...
class AddMovieToListVariables {
  ...
  listId = nativeFromJson<String>(json['listId']),
  movieId = nativeFromJson<String>(json['movieId']),
  note = nativeFromJson<String>(json['note']),
